...
| **团队成员** | **主要贡献**                                                 |
| ------------ | ------------------------------------------------------------ |
| 张嘉文     | 梳理项目开发需求、封装工具类、技术选型、文档编写、负责 LLM 接口调用。|
| 殷郝月     | 成员技术能力调查、项目整体组件架构、项目架构优化。                  |
...
<video controls width="100%"><source src="img\video.mp4" type="video/mp4"></video>

小程序:

![img](img\xiaochengxu.gif)
